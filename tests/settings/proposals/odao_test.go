...
func testOdaoParameterProposal(t *testing.T, setter func(*oracle.OracleDaoSettings), proposer func() (*eth.TransactionInfo, error)) {
	...
	err = rp.BatchCreateAndWaitForTransactions([]func() (*eth.TransactionSubmission, error){
		func() (*eth.TransactionSubmission, error) {
			return eth.CreateTxSubmissionFromInfo(prop.VoteOn(true, odao2.Transactor))
		},
		func() (*eth.TransactionSubmission, error) {
			return eth.CreateTxSubmissionFromInfo(prop.Execute(odao2.Transactor))
		},
