...
func contractETHBalance(rp *rocketpool.RocketPool, tokenContract *core.Contract, opts *bind.CallOpts) (*big.Int, error) {
	var blockNumber *big.Int
	if opts != nil {
		blockNumber = opts.BlockNumber
	}
...
func totalSupply(tokenContract *core.Contract, tokenName string, opts *bind.CallOpts) (*big.Int, error) {
...
// Get a token balance
func balanceOf(tokenContract *core.Contract, tokenName string, address common.Address, opts *bind.CallOpts) (*big.Int, error) {
	balance := new(*big.Int)
...
func allowance(tokenContract *core.Contract, tokenName string, owner, spender common.Address, opts *bind.CallOpts) (*big.Int, error) {
...
func estimateTransferGas(tokenContract *core.Contract, tokenName string, to common.Address, amount *big.Int, opts *bind.TransactOpts) (rocketpool.GasInfo, error) {
	return tokenContract.GetTransactionGasInfo(opts, "transfer", to, amount)
}

// Transfer tokens to an address
func transfer(tokenContract *core.Contract, tokenName string, to common.Address, amount *big.Int, opts *bind.TransactOpts) (common.Hash, error) {
...
func estimateApproveGas(tokenContract *core.Contract, tokenName string, spender common.Address, amount *big.Int, opts *bind.TransactOpts) (rocketpool.GasInfo, error) {
	return tokenContract.GetTransactionGasInfo(opts, "approve", spender, amount)
}

// Approve a token allowance for a spender
func approve(tokenContract *core.Contract, tokenName string, spender common.Address, amount *big.Int, opts *bind.TransactOpts) (common.Hash, error) {
...
func estimateTransferFromGas(tokenContract *core.Contract, tokenName string, from, to common.Address, amount *big.Int, opts *bind.TransactOpts) (rocketpool.GasInfo, error) {
	return tokenContract.GetTransactionGasInfo(opts, "transferFrom", from, to, amount)
}

// Transfer tokens from a sender to an address
func transferFrom(tokenContract *core.Contract, tokenName string, from, to common.Address, amount *big.Int, opts *bind.TransactOpts) (common.Hash, error) {
